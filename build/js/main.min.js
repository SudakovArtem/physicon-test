...
/* harmony import */ var _modules_init_purchase_range__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-purchase-range */ "./js/modules/init-purchase-range.js");
...
Object(_modules_init_purchase_range__WEBPACK_IMPORTED_MODULE_2__["initPurchaseRange"])();
Object(_modules_pendulum__WEBPACK_IMPORTED_MODULE_3__["initPendulum"])();

/***/ }),

/***/ "./js/modules/init-purchase-range.js":
/*!*******************************************!*\
  !*** ./js/modules/init-purchase-range.js ***!
  \*******************************************/
/*! exports provided: initPurchaseRange */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPurchaseRange", function() { return initPurchaseRange; });
...
var initPurchaseRange = function initPurchaseRange() {
  var deviationInput = document.querySelector("#".concat(purchaseSlider.dataset.input));
...
var initPendulum = function initPendulum() {
  ...
  window.deviationSlider.on('update', function (values, handle) {
    ...
    spring.style.height = "".concat(getNumberFromPrice(values[handle]) * (lenth / 20) + minLenth, "px");
